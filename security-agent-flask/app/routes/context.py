...
from ..providers import create_space, delete_space, get_space, list_spaces, update_space
...
@bp.patch("/context/spaces/<space_id>")
...
@bp.delete("/context/spaces/<space_id>")
def delete_space_route(space_id: str):
    """Remove o Space e o que depende dele. Só no modo mock (memória)."""
    return jsonify(delete_space(space_id))
